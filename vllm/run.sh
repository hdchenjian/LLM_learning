...
if [ 0 -ge 1 ]; then
    ...
    evalscope perf \
              ...
              --tokenizer-path qwen2.5-0.5B-Instruct \
    ...
    python -m vllm.entrypoints.openai.api_server --model qwen2.5-0.5B-Instruct --port 8001 --dtype bfloat16 --max-model-len 4096 --cpu-offload-gb 10 --max_num_seqs=16 --gpu-memory-utilization 0.7 --served-model-name qwen2.5 --trust-remote-code
